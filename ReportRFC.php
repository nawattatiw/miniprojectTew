            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Report RFC</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dbRFC" width="100%" >
                                ...
                                <?php
                                include('connect.php');
                                $query = "SELECT * FROM requestorder ORDER BY ordercustomer " or die("Error:" . mysqli_error());
                                $result = mysqli_query($conn, $query);
                                while($row = mysqli_fetch_array($result)) {
                                    echo "<tr>";
                                    echo "<td>" . $row["ordercustomer"]. "</td>";
                                    echo "<td>" . $row["orderdate"]. "</td>";
                                    echo "<td>" . $row["orderproductname"]. "</td>";
                                    echo "<td>" . $row["orderpiece"]. "</td>";
