...
// echo $row;
if($rs['orderid'] !=""){
    $sub = substr($rs['orderid'],1)+1;
    $orderid = sprintf('T%03.0f', $sub);
    // $courseId = "c".$sub;
}else{
    $orderid = "T001";
}
            ...
            <div class="container-fluid">
                ...
                <div class="row" >
                    ...
                    <div class="col">
                        ...
                        <form action="creatorder.php" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
...
if(isset($_POST['save'])){//เมื่อกดปุ่ม save
    ...
    //คำสั่ง sql
    $sql1 = "INSERT INTO orderfence(orderid,orderstatus,ordernamecus,ordercontact,orderaddress,typepd,ordernameproduct,orderpieceproduct,orderdetailproduct,orderservicecharge,ordertotalprice,orderdatebuy) 
            VALUES('$orderid','$orderstatus','$ordernamecus','$ordercontact','$orderaddress','$typepd','$ordernameproduct','$orderpieceproduct','$orderdetailproduct','$orderservicecharge','$ordertotalprice','$orderdatebuy')";
